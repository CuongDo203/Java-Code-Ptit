...
class TienDien{
	...
	public double getPhuTroi() {
		if(soMoi-soCu>100) return Math.round(thanhTien());
		else if(soMoi-soCu>=50) return Math.round(thanhTien()*35/100);
		else return 0;
	}
	...
	public String toString() {
		return maKh+" "+getHeSo()+" "+df.format(thanhTien())+" "+
	df.format(getPhuTroi())+" "+df.format(getTongTienPhaiTra());
	}
